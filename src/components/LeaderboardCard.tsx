...
import { Card, ListItem, ListItemText, Chip, Collapse, List, ListSubheader } from '@mui/material'
    ...
    <Card key={player.id} className="list-item card">
                ...
                <Collapse in={open[player.id]} timeout="auto" unmountOnExit>
                  ...
                  >
                    <ListItem sx={{ pl: 4 }}>
                      <ListItemText
                        primary={`${player.roundsPlayed.length} ${player.roundsPlayed.length===1? "round" : "rounds"}`}
                        ...
                        {player.bestRounds[0] ? (
                          <>
                            <ListItemText
                              ...
                              secondary={`${player.bestRounds[0].datePlayed.toString().slice(
                                0,
                                10
                              )} `}
                            />
                        ...
                        {player.bestRounds[1] ? (
                          <>
                            <ListItemText
                              ...
                              secondary={`${player.bestRounds[1].datePlayed.toString().slice(
                                0,
                                10
                              )} `}
                            />
                        ...
                        {player.bestRounds[2] ? (
                          <>
                            <ListItemText
                              ...
                              secondary={`${player.bestRounds[2].datePlayed.toString().slice(
                                0,
                                10
                              )} `}
                            />
