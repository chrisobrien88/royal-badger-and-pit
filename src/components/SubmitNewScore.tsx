...
const SubmitNewScore = () => {
  ...
  const updateHandicap = (newScore: number) => {
    ...
    if (newScore > worstScore && bestScoresLength > 1) {
      setBestScores(
        bestScores
          .slice(0, bestScoresLength - 1)
          .concat(slopeAdjustedThirtySixHandicapStablefordScore)
      );
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await Axios.post(
        `https://cerise-iguana-kit.cyclic.app/api/players/${userName}/submit-new-round`,
        {
          userName: userName,
          courseHandicap: 0,
        ...
        >
          <List>
            ...
            {handicapIndex ? (
              <>
                ...
                <ListItemText
                  secondary="Course Handicap"
                  primary={courseHandicap}
                />
              </>
            ) : null}
          </List>
          ...
          >
            ...
            >
              ...
              <Chip
                label={`${
                  eighteenHandicapStablefordScore + courseHandicap - 18
                } pts`}
                sx={{
                  backgroundColor:
                    holesPlayed === 18 ? "success.main" : "grey.500",
